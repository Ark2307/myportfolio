...
const JOURNEY: JourneyEntry[] = [
  ...
  },
  {
    version: "v2.0",
    year: "2022",
    role: "Hackathon Winnings",
    tag: "Solving problems",
    detail: "Won a silver medal in Celesta, a hackathon hosted by IIT Patna.",
  },
  {
    version: "v3.0",
    year: "2023",
    role: "Joined Akto",
    tag: "API Security",
    detail: "Moved into open-source API security — built the UI in Vue, my first contribution to the company. Later revamped the entire dashboard UI.",
  },
  {
    version: "v4.0",
    year: "2024",
    ...
    detail: "Took complete ownership of features in the Dashboard, from design to production.",
  },
  {
    version: "v5.0",
    year: "2025",
    role: "Entry to Agentic World",
    tag: "AI projects and RAG systems",
    detail: "Building AI solutions for red-teaming and guardrail AI agents.",
  },
  {
    version: "v5.1",
    year: "2026",
    role: "Today",
    tag: "Writing · Building",
